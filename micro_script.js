  ...
  modal.innerHTML = `
    <div class="history-panel study-panel">
      ...
      <div class="study-sticky-search">
        <div class="study-search-wrap" style="display:flex;align-items:center;gap:10px;">
  ...
  container.innerHTML = items.map((item, index) => {
    ...
    return `
      <div class="study-card favorite-question-card">
        ...
        ` : `
          <div class="study-correct-answer-only" style="margin-top:12px;padding:12px 14px;border-radius:16px;background:rgba(34,197,94,0.10);border:1px solid rgba(34,197,94,0.20);font-weight:800;">
